...
exports.run = async (client, message, args, prefix) => {
  ...
  .setColor("#3D97CB")
    .setTitle("Host a Customs Game")
    .setDescription(
      "Please click on the " + `${emoji1}` + " below to create a customs game. You will receive a direct message from ADAPT with further instructions."
    )
    .setFooter("Created By Astral");
